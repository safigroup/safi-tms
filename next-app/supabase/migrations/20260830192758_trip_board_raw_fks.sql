-- Expose the raw customer_id/route_id/driver_id (truck_id already added
-- earlier) on trip_board so the admin-override edit form can pre-fill its
-- dropdowns without a separate fetch. Appended as the last columns,
-- everything else identical to the view as it stood in
-- 20260830111343_route_border_paths.sql.
